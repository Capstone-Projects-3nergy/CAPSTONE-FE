          ...
          <div>
            ...
            <div v-if="lineId" class="flex items-center h-[58px]">
              <div
                ...
                class="flex items-center gap-2 px-4 py-3 rounded-2xl transition-all duration-300 bg-green-50 text-green-700 cursor-pointer hover:bg-green-100 border border-green-100 font-bold max-w-fit"
              >
