        ...
        <tbody class="bg-white divide-y divide-gray-100">
          ...
          <tr v-for="item in items" :key="item.id" class="hover:bg-gray-50/50 transition-colors duration-150">
            ...
            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
              <button @click="$emit('edit', item)" class="text-gray-400 hover:text-blue-600 transition-colors mx-2" title="Edit">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>
              </button>
              <button @click="$emit('delete', item)" class="text-gray-400 hover:text-red-600 transition-colors mx-2" title="Delete">
