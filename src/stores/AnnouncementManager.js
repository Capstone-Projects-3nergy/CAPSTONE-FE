    ...
    [
      {
        ...
        content:
          'Water will be shut off from 08:00–14:00 on February 20, 2026, for main plumbing repairs. Please reserve water in advance. We apologize for the inconvenience. If you have any questions, please contact the staff at the counter.',
        category: 'Urgent',
        type: 'news',
        status: 'Published',
        pinned: true,
      ...
      },
      {
        ...
        content:
          'The elevator will be closed for service on February 21-22, 2026, for annual inspection and maintenance by specialized technicians. Residents may use the stairs on the left side of the building.',
      ...
      },
      {
        ...
        content:
          'Starting from March 1, 2026, residents must collect their parcels within 7 days of notification. A storage fee may apply if overdue.',
        category: 'General',
        type: 'news',
        status: 'Published',
        pinned: false,
      ...
      },
      {
        ...
        content:
          'Learn how to start your own balcony garden. We provide seeds and tools. Meeting point: Roof garden, Building B.',
        category: 'Events',
        type: 'event',
        status: 'Published',
        pinned: true,
      ...
      },
      {
        ...
        content:
          'Start your Sunday with relaxation and stretching. Bring your own mat and water. Professional instructor provided by the community center.',
        category: 'Events',
        type: 'event',
        status: 'Published',
        pinned: false,
      ...
      },
      {
        ...
        content:
          "Over 20 stalls featuring international cuisine. Live music and children's activities. Entrance is free for residents.",
        category: 'Events',
        type: 'event',
        status: 'Published',
        pinned: false,
      ...
      },
      {
        ...
        content:
          'An informative session with local police officers to discuss safety tips and neighborhood vigilance. Highly recommended for all heads of households.',
        category: 'Events',
        type: 'event',
        status: 'Published',
        pinned: false,
      ...
      },
      {
        ...
        content:
          'Popcorn and soft drinks will be provided. Bring your own blankets or folding chairs. Screening starts at 7:30 PM in the central courtyard.',
        category: 'Events',
        type: 'event',
        status: 'Published',
        pinned: false,
      ...
      },
      {
        ...
        content:
          "All registration fees will be donated to the local children's hospital. T-shirts and medals for all participants. Register at the front office.",
        category: 'Events',
        type: 'event',
        status: 'Published',
        pinned: false,
      ...
      type: item.type || (item.category === 'Events' ? 'event' : 'news')
    }))
  )
